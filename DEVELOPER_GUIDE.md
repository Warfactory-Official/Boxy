...
| `distantEntityDepthMode` | `BASIC` | Distant-entity z-fighting fix: `OFF` / `BASIC` (one pass, depth exact) / `PRECISE` (multi-pass, exact occlusion + full 24-bit internal depth; behaves like `BASIC` under shaderpacks). |
